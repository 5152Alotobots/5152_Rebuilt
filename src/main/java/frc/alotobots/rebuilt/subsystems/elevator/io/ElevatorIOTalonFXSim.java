...
*/
package frc.alotobots.rebuilt.subsystems.elevator.io;
...
import static frc.alotobots.rebuilt.subsystems.elevator.constants.ElevatorConstants.Limits.LIMITS_ENABLED;
import static frc.alotobots.rebuilt.subsystems.elevator.constants.ElevatorConstants.Limits.MAX_HEIGHT;
import static frc.alotobots.rebuilt.subsystems.elevator.constants.ElevatorConstants.Limits.MIN_HEIGHT;
import static frc.alotobots.rebuilt.subsystems.elevator.constants.ElevatorTalonFXRealConstants.HEIGHT_PER_ROTATION;
import static frc.alotobots.rebuilt.subsystems.elevator.constants.ElevatorTalonFXRealConstants.MECHANISM_NEUTRAL_MODE;
import static frc.alotobots.rebuilt.subsystems.elevator.constants.ElevatorTalonFXSimConstants.HardwareConstants.ELEVATOR_MASS_KG;
import static frc.alotobots.rebuilt.subsystems.elevator.constants.ElevatorTalonFXSimConstants.HardwareConstants.GEAR_RATIO;
import static frc.alotobots.rebuilt.subsystems.elevator.constants.ElevatorTalonFXSimConstants.HardwareConstants.PULLEY_RADIUS_M;
...
import frc.alotobots.rebuilt.subsystems.elevator.constants.ElevatorTalonFXRealConstants.MotionMagicConstants;
import frc.alotobots.rebuilt.subsystems.elevator.constants.ElevatorTalonFXRealConstants.PIDConstants;
    ...
    tryUntilOk(
        ...
        () ->
            rightTalon.setControl(
                new Follower(leftTalon.getDeviceID(), MotorAlignmentValue.Aligned)));
