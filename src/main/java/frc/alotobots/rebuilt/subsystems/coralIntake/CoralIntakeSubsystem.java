...
*/
package frc.alotobots.rebuilt.subsystems.coralIntake;

import static frc.alotobots.rebuilt.subsystems.coralIntake.constants.CoralIntakeConstants.Limits.*;

import edu.wpi.first.math.MathUtil;
import edu.wpi.first.units.measure.AngularVelocity;
import edu.wpi.first.wpilibj2.command.SubsystemBase;
import frc.alotobots.rebuilt.subsystems.coralIntake.io.CoralIntakeIO;
import frc.alotobots.rebuilt.subsystems.coralIntake.io.CoralIntakeIOInputsAutoLogged;
