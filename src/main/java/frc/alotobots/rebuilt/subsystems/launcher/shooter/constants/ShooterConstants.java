...
public class ShooterConstants {
  ...
  public static final class Thresholds {
    ...
    public static final Time SHOOTER_AT_TARGET_VELOCITY_TIME_THRESHOLD_RISING = Seconds.of(.2);

    public static final Time SHOOTER_AT_TARGET_VELOCITY_TIME_THRESHOLD_FALLING = Seconds.of(.4);
  }
