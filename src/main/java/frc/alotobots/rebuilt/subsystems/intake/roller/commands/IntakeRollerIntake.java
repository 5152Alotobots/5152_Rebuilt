...
import static frc.alotobots.rebuilt.subsystems.intake.roller.constants.IntakeRollerConstants.Limits.MAX_OPEN_LOOP_INTAKE_PERCENTAGE;
...
public class IntakeRollerIntake extends Command {
  private IntakeRollerSubsystem intakeRollerSubsystem;
  private DoubleSupplier input;

  public IntakeRollerIntake(IntakeRollerSubsystem intakeRollerSubsystem, DoubleSupplier input) {
