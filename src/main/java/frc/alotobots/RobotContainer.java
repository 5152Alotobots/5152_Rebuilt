...
import frc.alotobots.rebuilt.commands.AlignToCoralStation;
import frc.alotobots.rebuilt.commands.AlignToReefBranch;
import frc.alotobots.rebuilt.commands.groups.Climb;
import frc.alotobots.rebuilt.commands.groups.UnClimb;
import frc.alotobots.rebuilt.commands.states.algae.StateAlgaeRemoveL2;
import frc.alotobots.rebuilt.commands.states.algae.StateAlgaeRemoveL3;
import frc.alotobots.rebuilt.commands.states.coral.*;
import frc.alotobots.rebuilt.subsystems.climber.ClimberSubsystem;
import frc.alotobots.rebuilt.subsystems.climber.commands.ClimberDisableServos;
import frc.alotobots.rebuilt.subsystems.climber.io.ClimberIORevServoReal;
import frc.alotobots.rebuilt.subsystems.coralIntake.CoralIntakeSubsystem;
import frc.alotobots.rebuilt.subsystems.coralIntake.io.CoralIntakeIO;
import frc.alotobots.rebuilt.subsystems.coralIntake.io.CoralIntakeIOTalonFXReal;
import frc.alotobots.rebuilt.subsystems.elevator.ElevatorSubsystem;
import frc.alotobots.rebuilt.subsystems.elevator.commands.DefaultElevatorRunAtVelocity;
import frc.alotobots.rebuilt.subsystems.elevator.io.ElevatorIO;
import frc.alotobots.rebuilt.subsystems.elevator.io.ElevatorIOTalonFXReal;
import frc.alotobots.rebuilt.subsystems.elevator.io.ElevatorIOTalonFXSim;
import frc.alotobots.rebuilt.subsystems.wrist.WristSubsystem;
import frc.alotobots.rebuilt.subsystems.wrist.commands.DefaultWristRunAtVelocity;
import frc.alotobots.rebuilt.subsystems.wrist.io.WristIOTalonFXReal;
import frc.alotobots.rebuilt.subsystems.wrist.io.WristIOTalonFXSim;
