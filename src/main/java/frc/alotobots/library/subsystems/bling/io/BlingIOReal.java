...
import com.ctre.phoenix6.controls.*; // Imports ControlRequest, RainbowAnimation, LarsonAnimation, etc.
...
public class BlingIOReal implements BlingIO {
  ...
  public void setSolidColor(LoggedColor color, int startIdx, int count) {
    ...
    clearAnimation();
    currentAnimation = new SolidColor(startIdx, startIdx + count).withColor(new RGBWColor(color.red(), color.green(), color.blue()));
